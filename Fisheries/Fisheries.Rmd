...
```{r region, include=TRUE, fig.height= 6.5, fig.width= 9, fig.align='center', warning=FALSE, message=FALSE}
fig1<-fish.df%>%
...
```{r fig2, Include=TRUE, fig.height= 7, fig.width= 8.5, fig.align="center", message=FALSE, warning=FALSE}
...
```{r fig3, include=TRUE, fig.height= 7, fig.width= 8.5,fig.align="center", warning=FALSE, message=FALSE}
...
```{r fig4, include=FALSE, fig.height= 7, fig.width= 8.5, fig.align="center", message=FALSE, warning=FALSE}
...
```{r fig5, include=FALSE, fig.height= 7, fig.width= 8.5, fig.align="center", message=FALSE, warning=FALSE }
#Plotly to make the chart more interactive
fig5<- ggplotly(fig3)%>%
...
```{r fig6, include=TRUE, fig.height= 7, fig.width= 8.5, fig.align="center", message=FALSE, warning=FALSE}
...
```{r corr, include=TRUE, fig.height= 7, fig.width= 8, fig.align="center", message=FALSE, warning=FALSE, echo=FALSE }
...
```{r quadplot, echo=FALSE, fig.show="hold", out.width="50%"}
fig8
fig9
```


```{r quadrant2, echo=FALSE, fig.height= 6, fig.width= 8, fig.align="center"}
#carbs
cal_mean<-mean(fish.df$calories, na.rm = TRUE)
...
```{r quadplot2, echo=FALSE, fig.show="hold", out.width="50%"}
fig10
fig11
```
...
The goal is to have comparable values. I selected fruits and vegetables with the highest calories. This will be the same with the fish species selected. There is substantial cleaning, re-arranging, renaming and binding dataframes. thankfully, dplyr and tidyverse have all the tools for this. 
 
```{r vegetables, include=FALSE, message=FALSE, warning=FALSE}
...
```{r fig12, include=TRUE, fig.align='center', fig.height=6, fig.width=12}
...
#)%>% layout(legend=list(title="Percentage RDA"),
           ...
           #yaxis=list(title=""))
```
**Note:** Grey tiles indicate observations that are lacking data. One might scrap the web for missing data and fill them in. For consistency, i only used data from the sources i listed earlie (which has some missing values for some observations).

```{r fig13, include=TRUE, fig.height= 7, fig.width= 8.5, fig.align="center", message=FALSE, warning=FALSE}
