...
```{r fig2, include=TRUE, fig.height= 5, fig.width= 10, results="hide", fig.align="center", echo=FALSE }
...
```{r fig3, include=FALSE, fig.height= 7.5, fig.width= 10, fig.align="center", warning=FALSE, message=FALSE}
...
```{r fig4, include=TRUE, fig.height= 7.5, fig.width= 10, fig.align="center", message=FALSE, warning=FALSE}
...
```{r fig5, include=FALSE, fig.height= 7.5, fig.width= 10, fig.align="center", message=FALSE, warning=FALSE }
#Plotly to make the chart more interactive
fig5<- ggplotly(fig3)%>%
...
```{r quad, Include=TRUE, fig.height= 7.5, fig.width= 10, fig.align="center", message=FALSE, warning=FALSE}
...
```{r corr, include=TRUE, fig.height= 6, fig.width= 8, fig.align="center", message=FALSE, warning=FALSE, echo=FALSE }
...
```{r quadrant, echo=FALSE, fig.align="center"}
#fat
